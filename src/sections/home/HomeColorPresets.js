    ...
    <RootStyle>
      <Container component={MotionViewport} sx={{ position: 'relative', textAlign: 'center' }}>
        ...
        <m.div variants={varFade().inUp}>
          ...
          >
            Express your own style with luxury facilities.
          </Typography>
        </m.div>
        ...
        <Box sx={{ position: 'relative' }}>
          ...
          <Box sx={{ position: 'absolute', top: 0 }}>
            <m.div animate={{ y: [15, -15, 15] }} variants={varFade().inUp}>
              <Image
                disabledEffect
                alt="screen"
                src='/static/preset/1.png'
              />
            </m.div>
          </Box>
          ...
          <Box sx={{ position: 'absolute', top: 0 }}>
            <m.div variants={varFade().inDown}>
              <m.div transition={{ duration: 8, repeat: Infinity }}>
                <Image
                  disabledEffect
                  alt="sidebar"
                  src='/static/preset/3.png'
                />
              </m.div>
            </m.div>
          </Box>
