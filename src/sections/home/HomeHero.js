...
import { MotionContainer, varFade } from '../../components/animateNew';
...
const HeroImgStyle = styled(m.img)(({ theme }) => ({
  ...
  borderRadius: '1rem',
  position: 'absolute',
  boxShadow: '0px 9px 20px 0px rgba(22, 26, 57, 0.36)',
          ...
          <ContentStyle>
            ...
            <m.div variants={varFade().inRight}>
              <Typography sx={{ color: 'common.white' }}>
                Jasmine Lane is a luxurious residential project located in the prestigious Jumeirah Golf Estates in Dubai developed by Durar Group, a developer known for its commitment to quality and luxury.
              </Typography>
            </m.div>
